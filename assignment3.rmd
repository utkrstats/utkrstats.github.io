...
Use both the flights and planes data table to answer this. Create a table of with columns, mean distance flown and number of seats. This table will be grouped by seat. </br>
